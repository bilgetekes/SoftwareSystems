...
public class Room {
     ...
     */
    // constructor for when you already have a safe ve onu sadece rooma atiyorsan
    public Room(int no , Safe safe) {
    	roomSafe = safe;
    	number = no;
    }
    // constructor for when you dont have a safe and want to create a new one
    ...
    public String toString(Room x) {
    	return "This room" + x + "has guest" + x.getGuest();
    }
}
